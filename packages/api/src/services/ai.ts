...
- {"type": "add_medication", "medication_name", "dose"?, "route"?, "form"?, "frequency"?, "schedule_times"? (array of "HH:MM"), "instructions"?, "units_per_dose"?, "supply"? (units a full pack provides), "packs_on_hand"? (unopened packs), "supplier"? (pharmacy or shop it is reordered from), "supplier_order_url"? (a link to reorder it), "with_food"?, "as_needed"?, "critical"?}
